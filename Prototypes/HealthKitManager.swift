...
class HealthKitManager: ObservableObject
{
    ...
    var stepCountToday: Int = 5000
    var stepCountYesterday: Int = 2200
    var stepCounterWeek: [Int: Int] = [1:0, 2:54, 3:5000, 4:321, 5:31, 6:12, 7:842]
    var caloriesBurnedToday: Int = 400
    var caloriesBurnedYesterday: Int = 600
  ...
  //          print("for day \(weekday) u have \(steps) steps!")
            self.stepCounterWeek[day] = steps
          }
        }

        print("\(self.stepCounterWeek)")
      }
      healthStore.execute(query)
    }
  }
